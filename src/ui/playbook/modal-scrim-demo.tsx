...
function SettingsPanel({ onOpen }: { onOpen: () => void }) {
  return (
    <div className="flex h-full flex-col items-center justify-center p-6">
      <p className="text-parchment-600 text-center text-sm">Workspace settings</p>
      <Button
        type="button"
        shape="round"
        size="sm"
      ...
      {open ? (
        <div className="absolute inset-0 z-20 flex items-center justify-center p-6">
          ...
          <div className="relative w-full max-w-xs rounded-xl bg-white p-4 shadow-lg ring-1 ring-black/10">
            <p className="text-parchment-900 text-sm font-medium">Delete workspace?</p>
            <p className="text-parchment-600 mt-1 text-xs">This cannot be undone.</p>
